...
for beta, lmax, (lamd1, U), ferr in iterlist:
    ...
    json_init = {
        ...
        "qmd1a": complex_2_json(qmdsa),
        "qmd1c": complex_2_json(qmdsc),
        "modLabel": complex_2_json(mode),
        "delt_res": complex_2_json(np.zeros(nmod)),
    ...
    magic_str = '{}-corr-dw-filter'.format(ferr)
